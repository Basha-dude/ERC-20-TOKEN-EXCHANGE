  ...
  return (
    ...
    <div className="component exchange__orders">
      ...
      <form onSubmit={ isBuy ? buyHandler : sellHandler } >
        ...
        <input value={amount ===0 ? '' : amount} type="text"  id='amount'  placeholder='0.0000' onChange={(e) => setAmount(e.target.value)} />
        ...
        <input value={price ===0 ? '' : price} type="text"  id='price'  placeholder='0.0000' onChange={(e) => setPrice(e.target.value)} />
